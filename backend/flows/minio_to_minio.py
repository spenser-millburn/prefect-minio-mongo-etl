...
@flow
def etl_pipeline(source_bucket_name, source_object_name, target_bucket_name, target_object_name):
...
if __name__ == "__main__":
    ...
    etl_pipeline(source_bucket_name, source_object_name, target_bucket_name, target_object_name)
