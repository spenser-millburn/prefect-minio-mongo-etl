...
def transform_data(log_lines_with_name):
    ...
    def process_event_sequence(event_sequence):
        ...
        return sequence_df, summary_df

    with ThreadPoolExecutor() as executor:
        results = list(executor.map(process_event_sequence, sequences))

    for sequence_df, summary_df in results:
